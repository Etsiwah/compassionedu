...
const TYPE_COLOURS = {
  ...
  everyone: 'text-blue-300 bg-blue-500/10 border-blue-500/25',
};
          ...
          {filtered.map(a => (
            <div
              ...
              <div className="flex items-start justify-between gap-3 flex-wrap">
                ...
                <div className="flex items-center gap-2">
                  <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full border capitalize ${TYPE_COLOURS[a.target_role] || TYPE_COLOURS.everyone}`}>
                    {a.target_role}
                  </span>
